      ...
      <div className="max-w-7xl mx-auto">
          ...
          {active ? (
            <div className="fixed inset-0 grid place-items-center z-[100] p-4">
              ...
              <div className="w-full max-w-7xl max-h-[90vh] flex gap-4">
                {/* Service Details Modal - Reduced width */}
                <motion.div
                  ...
                  animate={{ 
                    ...
                    scale: 1, 
                    y: 0,
                    width: showContactForm ? "60%" : "100%"
                  }}
                  exit={{ opacity: 0, scale: 1, y: 0, transition: { duration: 0 } }}
                  transition={{ duration: 0.4, ease: "easeOut" }}
                  className="flex flex-col backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl overflow-hidden shadow-2xl"
                >
              ...
              {/* Contact Form Modal - Appears beside service details */}
              <AnimatePresence>
                {showContactForm && (
                  <motion.div
                    ref={formRef}
                    ...
                    transition={{ duration: 0.4, ease: "easeOut" }}
                    className="w-[40%] flex flex-col backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl overflow-hidden shadow-2xl"
                  >
                    {/* Form Header */}
                    <div className="flex-shrink-0 p-6 pb-4 border-b border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            <motion.div
              layoutId={`card-${service.category}-${id}`}
            ...
            >
              <article className="h-full backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl overflow-hidden hover:bg-white/15 transition-all duration-500 hover:border-white/30 shadow-xl hover:shadow-2xl relative">
                ...
                <div className="relative z-10">
                  {/* Service Image */}
                  <motion.div layoutId={`image-${service.category}-${id}`} transition={{ duration: 0 }} className="relative h-48 overflow-hidden rounded-t-3xl">
                    <Image
                      src={service.image}
                  ...
                  <div className="p-6">
                    {/* Category Title */}
                    <motion.h3
                      layoutId={`title-${service.category}-${id}`}
                    ...
                    {/* Description */}
                    <motion.p
                      layoutId={`description-${service.category}-${id}`}
                      transition={{ duration: 0 }}
                      className="text-white/80 mb-4 text-sm leading-relaxed line-clamp-2"
                    >
                      {service.description}
                    </motion.p>
